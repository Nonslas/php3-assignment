                                                    ...
                                                    <div class="product-full-image main-slider image-popup">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-1.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-1.jpg') }}" alt="Product Image">
                                                            ...
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-2.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-2.jpg') }}" alt="Product Image">
                                                                    <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                                </a>
                                                                <figcaption class="visually-hidden">
                                                                    <span>Product Image</span>
                                                            ...
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-3.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-3.jpg') }}" alt="Product Image">
                                                                    <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                                </a>
                                                                <figcaption class="visually-hidden">
                                                                    <span>Product Image</span>
                                                            ...
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-4.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-4.jpg') }}" alt="Product Image">
                                                                    <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                                </a>
                                                                <figcaption class="visually-hidden">
                                                                    <span>Product Image</span>
                                                            ...
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-5.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-5.jpg') }}" alt="Product Image">
                                                                    <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                                </a>
                                                                <figcaption class="visually-hidden">
                                                                    <span>Product Image</span>
                                                            ...
                                                            <figure class="swiper-slide">
                                                                <a href="{{ asset('pebona/images/products/single/product-6.jpg') }}" data-size="600x600">
                                                                    <img src="{{ asset('pebona/images/products/single/product-6.jpg') }}" alt="Product Image">
                                                                    <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                                </a>
                                                                <figcaption class="visually-hidden">
                                                                    <span>Product Image</span>
                                                        ...
                                                        <div class="nav-slider">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-1.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-2.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-3.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-4.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-5.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="{{ asset('pebona/images/products/single/product-thumb-6.jpg') }}" alt="Product Thumbnail Image">
                                                                </div>
                                                            </div>

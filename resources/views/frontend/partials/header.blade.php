                    ...
                    <ul class="list-inline">
                        ...
                        <li class="language list-inline-item">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                       <li><a href="#" class="current"><img src="{{ asset('pebona/images/icons/en-gb.png') }}" alt="Icons"> English</a></li>
                                       <li><a href="#"><img src="{{ asset('pebona/images/icons/fr-fr.png') }}" alt="Icons"> Français</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-12 order-1 col-sm-12 order-sm-1 col-md-4 order-md-2 col-lg-6">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('pebona/images/logo.png') }}" alt="Logo" class="img-fluid"></a>
                    </div>
				</div>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="single-cart-item media">
                                                <div class="shopping-cart-img mr-4">
                                                    <a href="#">
                                                        <img class="img-fluid" alt="Cart Item" src="{{ asset('pebona/images/cart/cart-1.jpg') }}">
                                            ...
                                            <li class="single-cart-item media">
                                                <div class="shopping-cart-img mr-4">
                                                    <a href="#">
                                                        <img class="img-fluid" alt="Cart Item" src="{{ asset('pebona/images/cart/cart-2.jpg') }}">
                    ...
                    <li class="mega" data-columns="4"><a href="shop-grid.html"><span>Shop</span></a>
                        <ul class="mega-container">
                            ...
                            <li class="fullwidth-banner">
                            	<a href="#"><img src="{{ asset('pebona/images/banners/menu-banner.jpg') }}" alt="Menu Banner"></a>
                            </li>
                        </ul>
                    </li>
